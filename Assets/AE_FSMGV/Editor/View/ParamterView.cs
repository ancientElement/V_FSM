...
namespace AE_FSMGV
{
    public class ParamterView : VisualElement
    {
        public new class UxmlFactory : UxmlFactory<ParamterView, VisualElement.UxmlTraits> { }

        public AE_FSMGVWindow FSMEditorWindowGV;
        public Context Context => FSMEditorWindowGV.Context;

        public IMGUIContainer ParamterLayerContainer;
        public Rect rect => ParamterLayerContainer.contentRect;
        ...
        public void Init(AE_FSMGVWindow FSMEditorWindowGV)
        {
            ...
            ParamterLayerContainer = this.Q<IMGUIContainer>("ParamterLayer");
            ParamterLayerContainer.onGUIHandler = OnGUI;
        }

        public void OnGUI()
        {
            if (Context == null || Context.RunTimeFSMContorller == null) return;
